...
import { addToWatchlist, removeFromWatchlist, getWatchlist, removeFromWatchedList } from '../utils/watchlist';
                        ...
                        try {
                          ...
                          if (mediaIndex !== -1) {
                            ...
                            if (currentStatus) {
                              ...
                              await removeFromWatchedList(user.id, media.id, media.media_type);
                            }
