      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-20">
          ...
          <div className="prose dark:prose-invert max-w-none">
            <p className="text-sm text-gray-500 mb-4">Last Updated: March 3, 2026</p>
            ...
            <p className="mb-2">
              <span className="font-bold">Personal Information:</span> When you create an account, we collect your email address, username, and password. If you sign in with Google, we receive your name, email address, and profile photo from your Google account.
            </p>

            <p className="mb-2">
              <span className="font-bold">Profile Information:</span> Any profile information you provide, including profile pictures and other account details. If you sign in with Google, your Google profile photo may be used as your default profile picture.
            </p>
            ...
            <h2 className="text-xl font-semibold mt-6 mb-3">Google Sign-In</h2>

            <p className="mb-2">
              You may choose to sign in using your Google account. When you do, we access the following information from your Google account:
            </p>

            <ul className="list-disc pl-6 mb-4">
              <li>Your name (used to generate your username)</li>
              <li>Your email address (used as your account email)</li>
              <li>Your profile photo (used as your default avatar)</li>
            </ul>

            <p className="mb-4">
              We only access basic profile information necessary to create and maintain your account. We do not access your contacts, calendar, Google Drive, or any other Google services. Your Google password is never shared with us — authentication is handled securely by Google.
            </p>

            <p className="mb-4">
              You can disconnect your Google account at any time by deleting your VibeWatch account from the Profile screen. Our use and transfer of information received from Google APIs adheres to the <a href="https://developers.google.com/terms/api-services-user-data-policy" className="text-blue-500 hover:underline" target="_blank" rel="noopener noreferrer">Google API Services User Data Policy</a>, including the Limited Use requirements.
            </p>
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>Google, for authentication when you use Google Sign-In</li>
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>Delete your account entirely from the Profile screen</li>
